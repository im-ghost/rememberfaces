...
let names=["Peculiar","Richies","Racheal","Reenie","Chigozie","Richie","Israel","John","Joe","Emmanuel","Rihmeek","Williams","Johnson","Henry","Andrew","rut
...
function callNTimes(func, num, delay) {
    if (!num) return;
    func();
    setTimeout(function() { callNTimes( - 1func, num, delay); }, delay);
}
function(){
     
callNTimes(getIma3eNWord, l, 3200);
